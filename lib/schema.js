...
exports.HTTP_REQUEST_URL = "request.url";
exports.HTTP_REQUEST_METHOD = "request.method";
exports.HTTP_REQUEST_HOST = "request.host";
exports.HTTP_REQUEST_PATH = "request.path";
exports.HTTP_REQUEST_URL = "request.url";
exports.HTTP_STATUS_CODE = "response.status_code";
